...
const data = [
  {
    id: 1,
    imageUrl: `${basePath}/img/about/mobile-photo/about-mob-p1-1x.jpg`,
  ...
  {
    id: 2,
    imageUrl: `${basePath}/img/about/mobile-photo/about-mob-p2-1x.jpg`,
  ...
  {
    id: 3,
    imageUrl: `${basePath}/img/about/mobile-photo/about-mob-p3-1x.jpg`,
  ...
  {
    id: 4,
    imageUrl: `${basePath}/img/about/mobile-photo/about-mob-p4-1x.jpg`,
  ...
  {
    id: 5,
    imageUrl: `${basePath}/img/about/mobile-photo/about-mob-p5-1x.jpg`,
...
const aboutRender = data.map(({ id, text, imageUrl }) => {
  return `
   <div class="swiper-slide about-slide">
    <picture>
      <!-- десктоп -->
      <source media="(min-width: 1440px)" srcset="${basePath}/img/about/desktop-photo/abot-desk-p${id}.jpg 1x,
      ${basePath}/img/about/desktop-photo/abot-desk-p${id}.jpg 2x">
      <!-- планшет -->
      <source media="(min-width: 768px)" srcset="${basePath}/img/about/tablet-photo/about-tab-p${id}.jpg 1x,
      ${basePath}/src/img/about/tablet-photo/about-tab-p${id}.jpg 2x">
      <!-- мобілка -->
      <source media="(min-width: 320px)" srcset="${basePath}/img/about/mobile-photo/about-mob-p${id}.jpg 1x,
       ${basePath}/img/about/mobile-photo/about-mob-p${id}.jpg 2x">
