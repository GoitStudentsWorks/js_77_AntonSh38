...
const basePath = '/project_team_js2';

const data = [
  {
    id: 1,
    imageUrl: `${basePath}/src/img/about/mobile-photo/mobile1x-photo1.jpg`,
  ...
  {
    id: 2,
    imageUrl: `${basePath}/src/img/about/mobile-photo/mobile1x-photo2.jpg`,
  ...
  {
    id: 3,
    imageUrl: `${basePath}/src/img/about/mobile-photo/mobile1x-photo3.jpg`,
  ...
  {
    id: 4,
    imageUrl: `${basePath}/src/img/about/mobile-photo/mobile1x-photo4.jpg`,
  ...
  {
    id: 5,
    imageUrl: `${basePath}/src/img/about/mobile-photo/mobile1x-photo5.jpg`,
...
const aboutRender = data.map(({ id, text, imageUrl }) => {
  return `
   <div class="swiper-slide about-slide">
    <picture>
      <!-- десктоп -->
      <source media="(min-width: 1440px)" srcset="${basePath}/src/img/about/desktop-photo/desktop1x-photo${id}.jpg 1x,
      ${basePath}/src/img/about/desktop-photo/desktop2x-photo${id}.jpg 2x">
      <!-- планшет -->
      <source media="(min-width: 768px)" srcset="${basePath}/src/img/about/tablet-photo/tablet1x-photo${id}.jpg 1x,
      ${basePath}/src/img/about/tablet-photo/tablet2x-photo${id}.jpg 2x">
      <!-- мобілка -->
      <source media="(min-width: 320px)" srcset="${basePath}/src/img/about/mobile-photo/mobile1x-photo${id}.jpg 1x,
       ${basePath}/src/img/about/mobile-photo/mobile2x-photo${id}.jpg 2x">
