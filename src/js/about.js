...
const data = [
  {
    id: 1,
    imageUrl: '../img/about/mobile-photo/about-mob-p1-1x.jpg',
  ...
  {
    id: 2,
    imageUrl: '../img/about/mobile-photo/about-mob-p2-1x.jpg',
  ...
  {
    id: 3,
    imageUrl: '../img/about/mobile-photo/about-mob-p3-1x.jpg',
  ...
  {
    id: 4,
    imageUrl: '../img/about/mobile-photo/about-mob-p4-1x.jpg',
  ...
  {
    id: 5,
    imageUrl: '../img/about/mobile-photo/about-mob-p5-1x.jpg',
    ...
    <div class="swiper-slide about-slide">
      <picture>
        <source media="(min-width: 1440px)"
          srcset="img/about/desktop-photo/about-desk-p${id}-1x.jpg 1x,
        img/about/desktop-photo/about-desk-p${id}-2x.jpg 2x">

        <source media="(min-width: 768px)"
        srcset="img/about/tablet-photo/about-tab-p${id}-1x.jpg 1x,
        img/about/tablet-photo/about-tab-p${id}-2x.jpg 2x">
        
        <source media="(min-width: 320px)"
        srcset="img/about/mobile-photo/about-mob-p${id}-1x.jpg 1x,
        img/about/mobile-photo/about-mob-p${id}-2x.jpg 2x"></source>
